...
export const PROJECT_NAV: NavItem[] = [
  ...
  { slug: "catalogue",     label: "Catalogue",        icon: Package,         hint: "Deliverables and products",           group: "overview" },
  ...
  { slug: "taxonomy",      label: "Taxonomy",         icon: Tags,            hint: "Tags, phases and categories",         group: "overview" },
  { slug: "glossary",      label: "Glossary",         icon: BookOpen,        hint: "Shared terminology",                  group: "overview" },
